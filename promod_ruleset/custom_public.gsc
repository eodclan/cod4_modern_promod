main()
{
	...
	// mp arc audio
	setDvar("eodmp_gameend_party",1);
	setDvar("eodmp_roundend_party",1);
	setDvar("eodmp_mparccard",1);
	setDvar("eodmp_roundend_1", "eodmp_roundend_1");
	setDvar("eodmp_roundend_2", "eodmp_roundend_2");
	setDvar("eodmp_roundend_3", "eodmp_roundend_3");
	setDvar("eodmp_roundend_4", "eodmp_roundend_4");
	setDvar("eodmp_roundend_5", "eodmp_roundend_5");
	setDvar("eodmp_roundend_6", "eodmp_roundend_6");	
	...
	setDvar( "promod_mc_messagedelay_1", 10 ); // [1->] (overrides default delay in seconds between messages, e.g special messages)
	setDvar( "promod_mc_messagedelay_2", 10 );
